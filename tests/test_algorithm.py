...
class TestMiscellaneousAPI(WithLogger,
    ...
    END_DATE = pd.Timestamp('2006-01-03', tz='UTC')
...
"""
    ...
    def test_get_environment(self):
        expected_env = {
            ...
            'end': pd.Timestamp('2006-01-03 21:00:00+0000', tz='utc'),
    ...
    def test_event_context(self):
        ...
        self.assertEqual(len(expected_data), 390)
        ...
        self.assertEqual(
            len(function_stack),
            1950,
            'Incorrect number of functions called: %s != 1950' %
            len(function_stack),
        )
